...
interface PvPanelContextType {
  ...
  setPanelCharacteristics?: (characteristics: any) => void;
}
...
export const PvPanelProvider: React.FC<PvPanelProviderProps> = ({ children }) => {
  ...
  // Function to update panel characteristics
  const setPanelCharacteristics = (characteristics: PanelState['characteristics']) => {
    setPanelState(prev => ({
      ...prev,
      characteristics: {
